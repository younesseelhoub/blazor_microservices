...
namespace ProductOwner.MIcroservices.BackgroundServices
{
    public class RabbitMQBackgroundConsumerService : BackgroundService
    {
        ...
        protected override Task ExecuteAsync(CancellationToken stoppingToken)
        {
            ...
            consumer.Received += (ch, ea) =>
            {
                ...
                var productDetails = JsonConvert.DeserializeObject<Product>(message);
                ...
                using (var scope = serviceScopeFactory.CreateScope())
                {
                    ...
                    // update quantity
                    var product = _dbContext.Product.Find(productDetails.Id);
                    product.StockQuantity = product.StockQuantity - productDetails.StockQuantity;
